...
void setup(void) {
  ...
  pinMode(4, OUTPUT);  //reset pulse'ı pin 3
  ...
  //tft.drawFastHLine(0, 130, 63, ST7735_YELLOW);
  //tft.drawLine(1,160,1,1,ST7735_YELLOW);
  tft.drawFastHLine(1, 1, tft.width(), ST7735_YELLOW);
  tft.drawFastHLine(0, 101, tft.width(), ST7735_YELLOW);
  tft.drawFastVLine(64, 100, 59, ST7735_YELLOW);
  //tft.drawFastHLine(0, 100,  tft.width(), ST7735_YELLOW);
...
void loop() {
  ...
  if (val == 1) {
    deger = analogRead(A5);   // genliği okuduğum pin A5
    //deger=deger/1.6321;
    digitalWrite(4,HIGH);
...
//  tft.setCursor(4, 112);
//  tft.setTextColor(ST7735_, ST7735_BLACK);     // set text color to yellow and black background
//  tft.print(_buffer);
//  
//  // print time
